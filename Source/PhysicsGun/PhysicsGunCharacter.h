...
#include "PhysicsGunCharacter.generated.h"

class UInputComponent;

UCLASS(config=Game)
class APhysicsGunCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class APhysicsGunProjectile> ProjectileClass;

	
	/** Alt Projectile class to spawn */
	UPROPERTY(EditDefaultsOnly, Category=Projectile)
